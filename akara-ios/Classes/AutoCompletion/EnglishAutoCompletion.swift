...
class EnglishAutoCompletion: AutoCompletionable {
    private let charMap = (LanguageUtil.EN_ALPHABET_LOWER).unicodeScalars.map {(s) -> String in
        return String(s)
    }
    ...
    private func loadModel() {
        let path = AkaraBundle.main.path(forResource: "english_words_dict", ofType: "txt")!
        do {
