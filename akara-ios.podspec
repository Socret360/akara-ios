...
Pod::Spec.new do |s|
  s.name             = 'akara-ios'
  s.version          = '0.0.1'
  s.summary          = 'A short description of akara-ios.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/vaifathuy/akara-ios'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'vaifathuy' => 'vaifathuy@gmail.com' }
  s.source           = { :git => 'https://github.com/vaifathuy/akara-ios.git', :tag => s.version.to_s }
